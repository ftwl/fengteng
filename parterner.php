      ...
      <div class="subscribe section bg-white py-4 text">
        ...
        <div class="container">
            ...
            <table class="myTable">
             <tbody class="t-body">
                <tr>
                <th class="wrap t-header">合作商户</th>
                <th class="wrap t-header">联系方式</th>
                <th class="wrap t-header">地址</th>
                <th class="wrap t-header">更多</th>
              </tr>
              <tr class="t-line">
                <td class="wrap">中南世纪城有限公司</td>
                <td class="wrap">13801489449</td>
                <td class="wrap">江苏省南通市通州区平潮镇</td>
                <td class="wrap"><a href="./details.php">详情</a></td>
              </tr>
              <tr class="t-line">
                <td class="wrap">中南世纪城有限公司</td>
                <td class="wrap">13801489449</td>
